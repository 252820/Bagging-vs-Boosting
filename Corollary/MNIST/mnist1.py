...
#保存Model
joblib.dump(classifier1,'model_mnist1/base1_learner_mnist.pkl')
print("基分类器1pkl_size(MB):",os.path.getsize('model_mnist1/base1_learner_mnist.pkl')/1024/1024) #MB
...
time_bagging1,top1_bagging1,m_percent_bagging1=bagging_clf(classifier1,'model_mnist1/model1_bagging',n)
pkl_size_bagging1=get_dir_size('model_mnist1/model1_bagging')
...
bagging_result1.to_csv('model_mnist1/bagging_MNIST_result1.csv')
...
time_boosting1,top1_boosting1,m_percent_boosting1=boosting_clf(classifier1,'model_mnist1/model1_boosting',n)
pkl_size_boosting1=get_dir_size('model_mnist1/model1_boosting')
#保存结果
import pandas as pd
cb1={"基分类器个数" : n,
...
boost_result1.to_csv('model_mnist1/boosting_MNIST_result1.csv')
...
#保存Model
joblib.dump(classifier2,'model_mnist1/base2_learner_mnist.pkl')
print("基分类器2pkl_size(MB):",os.path.getsize('model_mnist1/base2_learner_mnist.pkl')/1024/1024)

#Bagging2
time_bagging2,top1_bagging2,m_percent_bagging2=bagging_clf(classifier2,'model_mnist1/model2_bagging',n)
pkl_size_bagging2=get_dir_size('model_mnist1/model2_bagging')
#保存结果
import pandas as pd
c2={"基分类器个数" : n,
...
bagging_result2.to_csv('model_mnist1/bagging_MNIST_result2.csv')
...
#保存Model
joblib.dump(classifier3,'model_mnist1/base3_learner_mnist.pkl')
print("基分类器3pkl_size(MB):",os.path.getsize('model_mnist1/base3_learner_mnist.pkl')/1024/1024)

# Bagging3
time_bagging3,top1_bagging3,m_percent_bagging3=bagging_clf(classifier3,'model_mnist1/model3_bagging',n)
pkl_size_bagging3=get_dir_size('model_mnist1/model3_bagging')
#保存结果
import pandas as pd
c3={"基分类器个数" : n,
...
bagging_result3.to_csv('model_mnist1/bagging_MNIST_result3.csv')
...
#保存Model
joblib.dump(classifier4,'model_mnist1/base4_learner_mnist.pkl')
print("基分类器4pkl_size(MB):",os.path.getsize('model_mnist1/base4_learner_mnist.pkl')/1024/1024)

# Bagging4
time_bagging4,top1_bagging4,m_percent_bagging4=bagging_clf(classifier4,'model_mnist1/model4_bagging',n)
pkl_size_bagging4=get_dir_size('model_mnist1/model4_bagging')
#保存结果
import pandas as pd
c4={"基分类器个数" : n,
...
bagging_result4.to_csv('model_mnist1/bagging_MNIST_result4.csv')
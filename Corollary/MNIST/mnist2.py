...
classifier1=DecisionTreeClassifier(criterion='gini',splitter='best',max_depth=25,min_samples_split=5,random_state=1234)#第一次测试最优
...
#保存Model
joblib.dump(classifier1,'model_mnist2/base1_learner_mnist.pkl')
print("基分类器1pkl_size(MB):",os.path.getsize('model_mnist2/base1_learner_mnist.pkl')/1024/1024) #MB
...
def bagging_clf(base_learner,target_dir,n):
    ...
    for i in tqdm(n):
        ...
        # 创建Bagging集成学习器
        bagging_clf = BaggingClassifier(base_estimator=base_learner, n_estimators=i, random_state=1234,n_jobs=-1,bootstrap=True)
...
time_bagging1,top1_bagging1,m_percent_bagging1=bagging_clf(classifier1,'model_mnist2/model1_bagging',n)
pkl_size_bagging1=get_dir_size('model_mnist2/model1_bagging')
...
bagging_result1.to_csv('model_mnist2/bagging_MNIST_result1.csv')
...
def boosting_clf(base_learner,target_dir,n):
    ...
    for i in tqdm(n):
        ...
        # AdaBoostClassifier
        boosting_clf = AdaBoostClassifier(base_estimator=base_learner, n_estimators=i, random_state=1234)
...
time_boosting1,top1_boosting1,m_percent_boosting1=boosting_clf(classifier1,'model_mnist2/model1_boosting',n)
pkl_size_boosting1=get_dir_size('model_mnist2/model1_boosting')
#保存结果
import pandas as pd
cb1={"基分类器个数" : n,
...
boost_result1.to_csv('model_mnist2/boosting_MNIST_result1.csv')
...
#保存Model
joblib.dump(classifier2,'model_mnist2/base2_learner_mnist.pkl')
print("基分类器2pkl_size(MB):",os.path.getsize('model_mnist2/base2_learner_mnist.pkl')/1024/1024)

#Bagging2
time_bagging2,top1_bagging2,m_percent_bagging2=bagging_clf(classifier2,'model_mnist2/model2_bagging',n)
pkl_size_bagging2=get_dir_size('model_mnist2/model2_bagging')
#保存结果
import pandas as pd
c2={"基分类器个数" : n,
...
bagging_result2.to_csv('model_mnist2/bagging_MNIST_result2.csv')

#Boosting2
time_boosting2,top1_boosting2,m_percent_boosting2=boosting_clf(classifier2,'model_mnist2/model2_boosting',n)
pkl_size_boosting2=get_dir_size('model_mnist2/model2_boosting')
#保存结果
import pandas as pd
cb2={"基分类器个数" : n,
...
print(boost_result2)
boost_result2.to_csv('model_mnist2/boosting_MNIST_result2.csv')


#基分类器3
memory_start3=psutil.Process(os.getpid()).memory_info().rss/1024/1024 #MB
start_time_base3=time.time()
classifier3=DecisionTreeClassifier(criterion='gini',splitter='best',max_depth=20,min_samples_split=5,random_state=1234)#第一次测试最优
...
#保存Model
joblib.dump(classifier3,'model_mnist2/base3_learner_mnist.pkl')
print("基分类器3pkl_size(MB):",os.path.getsize('model_mnist2/base3_learner_mnist.pkl')/1024/1024)

# Bagging3
time_bagging3,top1_bagging3,m_percent_bagging3=bagging_clf(classifier3,'model_mnist2/model3_bagging',n)
pkl_size_bagging3=get_dir_size('model_mnist2/model3_bagging')
#保存结果
import pandas as pd
c3={"基分类器个数" : n,
...
bagging_result3.to_csv('model_mnist2/bagging_MNIST_result3.csv')

# Boosting3
time_boosting3,top1_boosting3,m_percent_boosting3=boosting_clf(classifier3,'model_mnist2/model3_boosting',n)
pkl_size_boosting3=get_dir_size('model_mnist2/model3_boosting')
#保存结果
import pandas as pd
cb3={"基分类器个数" : n,
...
print(boost_result3)
boost_result3.to_csv('model_mnist2/boosting_MNIST_result3.csv')
...
classifier4=DecisionTreeClassifier(criterion='gini',splitter='best',max_depth=10,min_samples_split=5,random_state=1234)#第一次测试最优
...
#保存Model
joblib.dump(classifier4,'model_mnist2/base4_learner_mnist.pkl')
print("基分类器4pkl_size(MB):",os.path.getsize('model_mnist2/base4_learner_mnist.pkl')/1024/1024)

# Bagging4
time_bagging4,top1_bagging4,m_percent_bagging4=bagging_clf(classifier4,'model_mnist2/model4_bagging',n)
pkl_size_bagging4=get_dir_size('model_mnist2/model4_bagging')
#保存结果
import pandas as pd
c4={"基分类器个数" : n,
...
bagging_result4.to_csv('model_mnist2/bagging_MNIST_result4.csv')

# Boosting4
time_boosting4,top1_boosting4,m_percent_boosting4=boosting_clf(classifier4,'model_mnist2/model4_boosting',n)
pkl_size_boosting4=get_dir_size('model_mnist2/model4_boosting')
#保存结果
import pandas as pd
cb4={"基分类器个数" : n,
...
print(boost_result4)
boost_result4.to_csv('model_mnist2/boosting_MNIST_result4.csv')
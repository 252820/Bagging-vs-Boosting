...
Xtr,Ytr,Xte,Yte=load_cifar10("./datasets/cifar10/")
...
print("基分类器1pkl_size(MB):",os.path.getsize('model_cifar10/base1_learner_cifar10.pkl')/1024/1024) #MB
...
time_bagging1,top1_bagging1,m_percent_bagging1=bagging_clf(classifier1,'model_cifar10/model1_bagging',n)
...
time_boosting1,top1_boosting1,m_percent_boosting1=boosting_clf(classifier1,'model_cifar10/model1_boosting',n)
...
print("基分类器2pkl_size(MB):",os.path.getsize('model_cifar10/base2_learner_cifar10.pkl')/1024/1024)

#Bagging2
time_bagging2,top1_bagging2,m_percent_bagging2=bagging_clf(classifier2,'model_cifar10/model2_bagging',n)
...
#Boosting2
time_boosting2,top1_boosting2,m_percent_boosting2=boosting_clf(classifier2,'model_cifar10/model2_boosting',n)
...
print("基分类器3pkl_size(MB):",os.path.getsize('model_cifar10/base3_learner_cifar10.pkl')/1024/1024)

# Bagging3
time_bagging3,top1_bagging3,m_percent_bagging3=bagging_clf(classifier3,'model_cifar10/model3_bagging',n)
...
# Boosting3
time_boosting3,top1_boosting3,m_percent_boosting3=boosting_clf(classifier3,'model_cifar10/model3_boosting',n)
...
#保存Model
joblib.dump(classifier4,'model_cifar10/base4_learner_cifar10.pkl')
print("基分类器4pkl_size(MB):",os.path.getsize('model_cifar10/base4_learner_cifar10.pkl')/1024/1024)

# Bagging4
time_bagging4,top1_bagging4,m_percent_bagging4=bagging_clf(classifier4,'model_cifar10/model4_bagging',n)
pkl_size_bagging4=get_dir_size('model_cifar10/model4_bagging')
#保存结果
import pandas as pd
c4={"基分类器个数" : n,
...
bagging_result4.to_csv('model_cifar10/bagging_cifar10_result4.csv')

# Boosting4
time_boosting4,top1_boosting4,m_percent_boosting4=boosting_clf(classifier4,'model_cifar10/model4_boosting',n)
pkl_size_boosting4=get_dir_size('model_cifar10/model4_boosting')
#保存结果
import pandas as pd
cb4={"基分类器个数" : n,
...
print(boost_result4)
boost_result4.to_csv('model_cifar10/boosting_cifar10_result4.csv')